...
[![Streamlit App](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://travel-bud.streamlit.app/)  
**🔗 Live Demo:** [travel-bud.streamlit.app](https://travel-bud.streamlit.app/)
...
> **Prototype Status & API Availability:** Travel Buddy is an experimental engineering prototype designed to demonstrate multi-API orchestration and concurrency. Because it relies on free/public tiers of third-party APIs (Groq, Foursquare, WeatherAPI, Openverse, OSRM, and Nominatim), performance, response times, and feature availability may fluctuate due to upstream rate limits, schema updates, or temporary service quotas.
